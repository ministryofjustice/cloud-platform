...
Auth0 is useful as a broker, because it adds a login rule, that the user needs to be in the ministryofjustice GitHub organization the GitHub team, used by k8s RBAC authorization. (check)
