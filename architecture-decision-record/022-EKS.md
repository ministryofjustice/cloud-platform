...
Used for performance reasons - it caches requests by Calico Felix to the k8s API.
...
The logs go to CloudWatch. Maybe we need to export them elsewhere. Further discussion is covered in: [ADR 23 Logging](023-Logging.html)
